...
- **Status: this package has not yet been exercised end-to-end against a live provider** the way the Claude flavor's workflows were (see `test-harness/RESULTS.md`). Treat the first runs as shakedown.
